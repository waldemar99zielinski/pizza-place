...
import placeImage from "./../../assets/place.jpeg";
...
const AboutUs = () => {
  return (
    <div className="about-us-container">
      ...
      <section>
        {" "}
        <img src={ourMissionImage} alt="about-us"></img>
        <div>
          <h2>Our Mission</h2>
          <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
      ...
      <section>
        ...
        <img src={placeImage} alt="about-us"></img>
      </section>
      <section>
        {" "}
        <img src={staffImage} alt="about-us"></img>
        <div>
          <h2>Staff</h2>
          <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
